              ...
              <View className="flex-1">
                <View className="mb-2 flex-row flex-wrap items-center gap-x-2 gap-y-1">
                  {announcement.isPinned && (
                    <View className="flex-row items-center gap-x-1 rounded-md bg-amber-50 px-2 py-0.5 dark:bg-amber-900/20">
                  ...
                  <View
                    className={`rounded-full px-2 py-0.5 ${priorityColors[announcement.priority]}`}>
