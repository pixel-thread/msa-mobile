...
export const AnnouncementDetailScreen = () => {
  ...
  if (isLoading) return <LoadingScreen message="Loading announcement..." />;
      ...
      <ScrollView
        ...
        <View className="mb-4 flex-row flex-wrap items-center gap-x-2 gap-y-2">
          {announcement.isPinned && (
            <View className="flex-row items-center gap-x-1 rounded-md bg-amber-50 px-3 py-1.5 dark:bg-amber-900/20">
          ...
          <View
            className={`rounded-full px-3 py-1.5 ${priorityColors[announcement.priority]}`}>
          ...
          {!isRead && (
            <View className="rounded-full bg-indigo-50 px-3 py-1.5 dark:bg-indigo-900/20">
        ...
        {announcement.summary && (
          <View className="mb-6 rounded-lg bg-slate-50 p-4 dark:bg-slate-800">
        ...
        {expiresDate && (
          <View className="mt-6 rounded-lg border border-slate-200 p-4 dark:border-slate-700">
            <View className="flex-row items-center gap-x-2">
