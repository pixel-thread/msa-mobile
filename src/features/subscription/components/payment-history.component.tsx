    ...
    <View className="flex-1">
      ...
      <View className="flex-row flex-wrap gap-2 mb-6">
        {[
          ...
          <View
            key={idx}
            className="flex-1 min-w-[45%] rounded-xl border border-slate-100 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-900/50">
      ...
      {transactions.length === 0 ? (
        <View className="items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 py-12 dark:border-slate-800 dark:bg-slate-900/30">
