    ...
    return (
      <AlertDialog open={isVisible} onOpenChange={handleClose}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogAction title="Restart Now" onPress={handleApply} />
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    );
  ...
  return (
    <AlertDialog open={isVisible} onOpenChange={handleClose}>
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel title="Later" onPress={handleClose} />
          <AlertDialogAction title="Update Now" onPress={handleDownload} />
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  );
